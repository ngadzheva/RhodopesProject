...
var Landmark = /** @class */ (function (_super) {
    ...
    Landmark.prototype.load = function () {
        var _this = this;
        var landscape = {};
        database_1.database.queryData(collections_1.Collections.Lanscapes, fields_1.Fields.LanscapeName, conditions_1.Conditions.EqualTo, this._name)
            ...
            querySnapshot.forEach(function (doc) {
                ...
                landscape.lid = doc.id;
                landscape.name = _this._name;
                landscape.rhodopesPart = _this._rhodopesPart;
                landscape.description = _this._description;
                landscape.entranceFee = _this._entranceFee;
                landscape.location = _this._location;
                landscape.rating = _this._rating;
                landscape.shortInfo = _this._shortInfo;
                landscape.transitionTime = _this._transitionTime;
                landscape.workTime = _this._workTime;
            });
        });
        return landscape;
    };
    ...
    Object.defineProperty(Landmark.prototype, "setRating", {
        set: function (rating) {
            this._rating = rating;
            database_1.database.updateData(collections_1.Collections.Lanscapes, fields_1.Fields.LanscapeName, conditions_1.Conditions.EqualTo, this._name, { rating: this._rating });
        },
        enumerable: true,
        configurable: true
    });
